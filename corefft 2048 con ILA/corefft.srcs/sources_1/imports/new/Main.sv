...
module Main(
    ...
    localparam M=11; //2^M Cantidad de espacios de memoria
...
Save SaveUART (
        ...
        blk_mem_gen_0 datos_dominio_tiempo (
          ...
          .addra(dir_in_uart),  // input wire [10 : 0] addra
          .dina(dato_uart_in),    // input wire [31 : 0] dina
          .clkb(clk),    // input wire clkb
          .enb(1'b1),      // input wire enb
          .addrb(dir_time),  // input wire [10: 0] addrb
	 ...
	 blk_mem_gen_0 datos_dominio_frecuencia (
                     ...
                     .addra(dir_frequency),  // input wire [10 : 0] addra
                     .dina(dato_frequency),    // input wire [31 : 0] dina
                     .clkb(clk),    // input wire clkb
                     .enb(1'b1),      // input wire enb
                     .addrb(dir_out_uart),  // input wire [10 : 0] addrb

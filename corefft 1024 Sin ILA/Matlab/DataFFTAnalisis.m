...
% core FFT de Xilinx, usando los datos obtenidos por el ILA, los datos son guardados
...
L = 32;             % Length of signal %Se puede variar aqui el tamaño de muestras de la transformada a calcular

...
#
# Generated by Vivado on Mon Apr 15 00:02:57 -0400 2019
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Proyecto Final Digital/corefft UART Block RAM con FFT UartTx 1024 Sin ILA/corefft.cache/compile_simlib/activehdl"
  fi

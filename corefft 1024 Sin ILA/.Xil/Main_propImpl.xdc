set_property SRC_FILE_INFO {cfile:{d:/Proyecto Final Digital/corefft UART Block RAM con FFT UartTx 1024 Sin ILA/corefft.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc} rfile:../corefft.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc id:1 order:EARLY scoped_inst:CLK/inst} [current_design]
set_property SRC_FILE_INFO {cfile:{D:/Proyecto Final Digital/corefft UART Block RAM con FFT UartTx 1024 Sin ILA/corefft.srcs/constrs_1/imports/new/Constraints.xdc} rfile:../corefft.srcs/constrs_1/imports/new/Constraints.xdc id:2} [current_design]
